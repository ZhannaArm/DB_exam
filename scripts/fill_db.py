...
def create_albums(artist_ids):
    albums = [
        {"title": "1989", "release_year": 2014, "record_label": "Big Machine", "genre": "Pop", "artist_id": artist_ids["Taylor Swift"]},
        {"title": "Divide", "release_year": 2017, "record_label": "Asylum", "genre": "Pop", "artist_id": artist_ids["Ed Sheeran"]},
        {"title": "Lemonade", "release_year": 2016, "record_label": "Columbia", "genre": "R&B", "artist_id": artist_ids["Beyonce"]}
    ]
    for album in albums:
...
def create_tracks(artist_ids, album_ids):
    tracks = [
        {"title": "Blank Space", "duration": 231, "lyrics": "Got a long list of ex-lovers...", "play_count": 1000, "mood": "Energetic", "artist_id": artist_ids["Taylor Swift"], "album_id": album_ids["1989"]},
        {"title": "Shape of You", "duration": 233, "lyrics": "I'm in love with the shape of you...", "play_count": 2000, "mood": "Happy", "artist_id": artist_ids["Ed Sheeran"], "album_id": album_ids["Divide"]},
        {"title": "Formation", "duration": 240, "lyrics": "You know you that b****...", "play_count": 1500, "mood": "Confident", "artist_id": artist_ids["Beyonce"], "album_id": album_ids["Lemonade"]}
    ]
    for track in tracks:
